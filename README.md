...
&ensp; На гифке ниже можно наблюдать работу алгоритма.
...
&ensp; Результатом работы стала разработка двух алгоритмов для работы с видео, с целью вычисления разницы координат центров массс/центров областей, для определения смещения не стационарных объектов.
